 ...
 * {@link DetailsForm.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DetailsForm#newInstance} factory method to
...
public class DetailsForm extends Fragment {
    ...
    public String suspectedCrime;
    public String lastKnownLocation;
    public int viewholderColor;
    public String idimageref;
    public String imagename;


    private OnFragmentInteractionListener mListener;
    public Button submitButton;
    public TextInputEditText personName;
     ...
     * @return A new instance of fragment DetailsForm.
     */
    // TODO: Rename and change types and number of parameters
    public static DetailsForm newInstance(String param1, String param2) {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
           ...
           //         mListener.onFragmentInteraction(P);
                      P.setpersondetail(Name,hairColor,CNIC,skinColor,description,suspectedCrime,lastKnownLocation);
                    Log.d("msg", "I am here");
                }
    ...
    public void setOnDetailSelectedListener(OnFragmentInteractionListener listener)
    {
        mListener= listener;
    }
