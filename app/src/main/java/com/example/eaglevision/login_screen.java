 ...
 * {@link login_screen.OnFragmentInteractionListener} interface
...
public class login_screen extends Fragment {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_login_screen_to_main_menu);
            }
        });
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            ...
            mListener.userSignedIn(signedIn);
        }
    }
   ...
   //     }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void userSignedIn(boolean signedIn);
    }
}
