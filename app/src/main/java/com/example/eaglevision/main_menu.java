...
public class main_menu extends Fragment {
    ...
    private ImageButton acquireButton;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        directoryButton= (ImageButton) view.findViewById(R.id.directoryButton);
        acquireButton=(ImageButton) view.findViewById(R.id.videoButton);
        notifyButton=(ImageButton) view.findViewById(R.id.notificationsButton);

        acquireButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_main_menu_to_upload_acqusation);
            }
        });
        ...
        notifyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_main_menu_to_notify);
            }
        });
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_main_menu_to_upload_media_screen);
            }
        });
        ...
        directoryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_main_menu_to_directoryFragment);
            }
        });
